            ...
            <div className="accordion-body">
              ...
              <form>
                <div className="mb-3 col-8">
                  ...
                  />
                  <div id="singleItemHelp" className="form-text">
                    Enter the 16-digit number for a single barcode.
                  </div>
                </div>
                <div className="mb-3">
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              ...
              <form>
                <div className="row align-items-start mb-3">
                  <label className="col-form-label" htmlFor="division">
                    Division
                  </label>
                  <div className="col-4 mb-3">
                    <select
                      ...
                      name="division"
                    >
                      <option defaultValue="2230">5Y</option>
                    </select>
                  </div>
                  <div className="col-8">
                    <input
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <p>
                  The item information is located in the second box on the top
                  of the next screen. This number should end in '01'. Enter that
                  number into the application, then enter how many labels of
